...
import { relatoriosAPI, producaoAPI, estoqueAPI, vendasAPI } from '../services/api';
        ...
        <div className="space-y-6">
          ...
          {relatorioVendas && (
            <>
              ...
              <div className="bg-[#FFFDF8] border border-orange-200 rounded-xl p-6 shadow-sm md:col-span-3">
