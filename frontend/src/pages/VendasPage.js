                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-4 border border-purple-200">
                      ...
                      {formData.items.length > 0 && (
                        <div className="mt-3 bg-white rounded-lg p-3 border border-purple-200 space-y-2">
                          <h4 className="text-sm font-semibold text-purple-700 mb-2">🛒 Produtos Extras ({formData.items.length})</h4>
                          ...
                          <div className="flex justify-between pt-2 border-t border-purple-200">
                            ...
                            <span className="font-bold text-purple-800">{formatCurrency(formData.items.reduce((acc, item) => acc + (item.subtotal || 0), 0))}</span>
                          </div>
                        </div>
                      )}
                    </div>
